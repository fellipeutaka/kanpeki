...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: "Handler called when the disclosure expanded state changes.",
    },
    {
      name: "isDisabled",
      required: false,
    ...
    },
    {
      ...
      type: "ReactNode | (values: DisclosureRenderProps) => ReactNode",
      description: "The children of the disclosure.",
    },
  ]}
/>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: false,
      typeSimple: "ReactNode",
      description: "The children of the disclosure panel.",
    },
  ]}
/>
