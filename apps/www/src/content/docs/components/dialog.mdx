...
```tsx
// [!code word:isDismissable={false}]
// [!code word:role="alertdialog"]
<Dialog.Root>
  <Button>Trigger</Button>
...
If you need a dialog that slides in from the edge of the screen, check out the [Sheet](/docs/components/sheet) component.
