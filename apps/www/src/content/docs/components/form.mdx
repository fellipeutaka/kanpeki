...
Form accepts all props from React Aria's [Form](https://react-spectrum.adobe.com/react-aria/Form.html#props).

| Prop                 | Type                                 | Default    | Description                            |
| -------------------- | ------------------------------------ | ---------- | -------------------------------------- |
| `validationErrors`   | `Record<string, string \| string[]>` |            | Server-side validation errors          |
