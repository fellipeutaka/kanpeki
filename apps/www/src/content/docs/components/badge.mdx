...
| ------------- | ------------------------------------------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------ |
| `variant`     | `"default" \| "secondary" \| "outline" \| "destructive"{:ts}` | `"default"{:ts}` | The visual style of the badge.                                                                         |
| `nativeFocus` | `true \| false{:ts}`                                          | `true{:ts}`      | Use CSS native `:focus{:css}` or `[data-focused="true"]{:css}` to show the ring when badge is focused. |
