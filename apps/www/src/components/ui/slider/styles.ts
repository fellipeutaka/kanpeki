...
export const SliderStyles = {
  Root: cva({
    base: [
      "flex flex-col gap-2",
      "data-[orientation=vertical]:h-56 data-[orientation=vertical]:items-center",
  ...
  Track: cva({
    base: [
      ...
      "grow data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-1.5 data-[orientation=vertical]:flex-1",
    ],
  }),
  Thumb: cva({
    base: [
